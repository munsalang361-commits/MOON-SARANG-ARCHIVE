      ...
      <div className="section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          >
            <div className="aspect-[4/5] rounded-[40px] overflow-hidden relative">
              <img 
                src="https://loremflickr.com/1000/1250/portrait,professional" 
                alt="Moon Sarang" 
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl mb-8">디자인으로 비즈니스의 <br />해답을 찾습니다.</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-32">
          {[
            ...
            <div key={i} className="p-10 bg-white rounded-3xl border border-gray-100 hover:shadow-xl transition-all">
        ...
        <div className="bg-primary text-white p-12 md:p-20 rounded-[40px]">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-4xl mb-8 font-display">"디자인은 문제를 해결하는 가장 아름다운 방법입니다."</h2>
